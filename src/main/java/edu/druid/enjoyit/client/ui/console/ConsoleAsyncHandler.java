...
import static edu.druid.enjoyit.base.protocol.entity.SimpleRequest.DISCONNECT;
import static edu.druid.enjoyit.base.protocol.entity.SimpleRequest.GET_ROOMS;
import static edu.druid.enjoyit.base.protocol.entity.SimpleRequest.LEAVE_THE_ROOM;
import static edu.druid.enjoyit.base.protocol.entity.SimpleRequest.ROOM_STATUS;
...
public class ConsoleAsyncHandler extends AsyncComponent {
    ...
    public ConsoleAsyncHandler(Writer writer) {
        super(new Thread(new Listener(writer)));
